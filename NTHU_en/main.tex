...
\documentclass[oneside]{NTHU_thesis} % \documentclass[option1, option2, ...]
% Helpful options: 
...
\begin{document}
    ...
    \mainmatter
        \input{introduction}    % 緒論
        \input{ATLAS}          % 分析方法
        \input{object_selection}          % 實驗結果
        \input{event_selection}      % 結論
        \input{background_estimation}
        \input{result}
        \input{conclusion}
