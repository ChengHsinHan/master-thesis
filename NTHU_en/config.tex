...
\def\titleZh   {在MonoHbb分析中的W玻色子背景估計}   % Chinese title
\def\titleEn   {The Estimation of the Background of the W Boson in the MonoHbb Analysis} % English title
...
\def\degreedate{中~華~民~國~ \zhdigits{107} ~年~十二~月} % NTHU demo use O not 零
